...
const EventModal = ({ isOpen, onRequestClose, event, onUpdate, onDelete }) => {
  ...
  <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
    ...
    <div className="relative w-full max-w-lg bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-300">
      {/* Cabecera */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full bg-slate-800 border border-slate-700 text-white p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-2 flex items-center gap-2">
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-between items-center p-6 border-t border-slate-800 gap-3">
        <button 
